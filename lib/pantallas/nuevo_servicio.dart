...
class _NuevoVEN_Servicio extends State<NuevoVEN_Servicio> {
  ...
  void _mostrarDatos() {
    _tfCodigoServicio.text = widget.oServicio.codigoServicio.toString();
    _tfNombreCliente.text = widget.oServicio.nombreCliente.toString();
    _tfNumeroOrdenServicio.text = widget.oServicio.numeroOrdenServicio.toString();
  ...
  void _cargarEntidad() {
    widget.oServicio.codigoServicio = int.parse(_tfCodigoServicio.text);
